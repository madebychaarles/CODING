...
class Orb {
  ...
  constructor(fill = 0x000000) {
    ...
    this.radius = random(window.innerHeight / 10, window.innerHeight / 8);
  ...
  setBounds() {
    ...
    const maxDist = window.innerWidth < 900 ? window.innerWidth / 3 : window.innerWidth / 4;
